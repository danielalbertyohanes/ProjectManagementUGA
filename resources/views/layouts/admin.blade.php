    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                href="https://www.ubayaglobalacademy.com/">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-3">UGA</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseRekap" class="collapse" aria-labelledby="headingHotel"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href=""> Laporan Kedua </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <h4 style="color: blue;font-weight: bold">Sistem Informasi UGA</h4>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ route('employee.show', Auth::user()->id) }}">
    ...
    <aside class="sidebar">
        ...
        <ul>
            ...
            @if (Auth::user()->position_id == '1')
                ...
                <li><a href="{{ route('link_external.index') }}"><i class="fa fa-external-link-alt"></i> Master External Link</a></li>
                ...
                <li><a href="{{ route('report.rptPeriode') }}"><i class="fa fa-calendar-check"></i> Report Periode</a></li>
