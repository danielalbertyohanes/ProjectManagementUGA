<<<<<<< Updated upstream=======<link rel="stylesheet" href="{{ asset('admin/css/modal.css') }}">
    ...
    <form method="POST" action="{{ route('dosen.update', $dosen->id) }}">
        ...
        <div class="form-group">
            ...
            <<<<<<< Updated upstream <input type="text" class="form-control" id="dosenNpk" name="npk"
                ...
                <input type="text" class="form-control" id="dosenName" name="name"
                    placeholder="Enter Name of dosen" value="{{ $dosen->name }}" required
                    oninput="this.value = this.value.toUpperCase().replace(/[^A-Za-z\s]/g, '')">

                <label for="dosenFakutlas">Fakultas</label>
                <input type="text" class="form-control" id="fakultas" name="fakultas"
                    placeholder="Masukkan Fakultas" required value="{{ $dosen->fakultas }}"
                ...
                =======
                <input type="text" class="form-control" id="dosenNpk" name="npk" placeholder="Enter NPK"
        ...
        <div class="modal-footer">
            <<<<<<< Updated upstream <button type="submit" class="btn btn-primary">Submit</button>
